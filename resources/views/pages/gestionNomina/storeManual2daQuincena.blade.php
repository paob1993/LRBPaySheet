...
<div class="container-fluid">
   <div class="row">
      ...
      <div class="card col-md-12">
         <div class="header">
            <h4 class="title text-center" style="font-weight: 600;">Gestión de Nómina: 2da. Quincena Periodo {{$recibo->mes}}-{{$recibo->ano}}</h4>
         </div>
         <div class='content'>
            <div class="col-md-12">
               <div class="card" style="box-shadow: 0 1px 2px rgba(0, 0, 0, 0.00), 0 0 0 1px rgba(63, 63, 68, 0);">
                  <div class="card-header">
                     <h5 class="title"> Editar los empleados para asignar o descontar codigos manuales </h5>
                     <br>
                  </div>
                  <div class="card-body ">
                     <form class='form-horizontal' method='GET'>
                        ...
                        <div class="col-xs-12 text-center margin-top modal-footer">
                           <a href="javascript:confirmationModal('{{url('gestionNomina/segundaQuincena')}}','{{$recibo_id}}')">
