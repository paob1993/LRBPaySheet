            ...
            <div class="card">
                <div class="header">
                    ...
                    <p class="category">
                        <div class='col-xs-12'>
                            <p class='pull-right'>
                                <a id="download_button"class='btn btn-success' href="{{url('exportar/archivoBanco/segundaQuincena/'.$recibo->id)}}">Descargar <i class='fa fa-lg fa-download'></i></a>
                            </p>
                        </div>
                    </p>
                </div>
                        ...
                        <table class="table table-hover table-striped table-center">
                           ...
                           <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$recEmpleado->monto_total - $recEmpleado->primer_quincena}}</td>
                            </tr>
                            @endforeach
                            @endif
                        </tbody>
