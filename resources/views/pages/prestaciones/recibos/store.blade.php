         ...
         <div class="col-md-12">
            <div class="card" style="box-shadow: 0 1px 2px rgba(0, 0, 0, 0.00), 0 0 0 1px rgba(63, 63, 68, 0);">
               <div class="card-header">
                  <h5 class="title"><span style="font-weight: 600;"> 1er. Paso:</span> Escoger el trimestre</h5>
               </div>
               <div class="card-body ">
                  <!-- Paso 1 -->
                  <form class='form-horizontal' method='POST' action="..\recibosPrestaciones">
                     {!! csrf_field() !!}
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 margin-top div-fix-height">
                        ...
                        <select class="form-control" name="trimestre" id="trimestre">
                           @foreach(\App\OwnModels\Utilidades::$trimesters as $key => $value)
                           @if($key == old('trimesters'))
                     ...
                     <div class="col-xs-12 text-center margin-top modal-footer">
                        <button type="submit" class="btn btn-primary" id="btn-action-cestaticket">Siguiente</button>
